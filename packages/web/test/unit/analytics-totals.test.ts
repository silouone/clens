...
describe("parseCustomWindow", () => {
	test("returns a normalized window for valid from/to", () => {
		expect(parseCustomWindow("2026-06-01", "2026-06-07")).toEqual({ from: "2026-06-01", to: "2026-06-07" })
	})

	test("orders a reversed (right-to-left drag) selection", () => {
		expect(parseCustomWindow("2026-06-07", "2026-06-01")).toEqual({ from: "2026-06-01", to: "2026-06-07" })
	})
